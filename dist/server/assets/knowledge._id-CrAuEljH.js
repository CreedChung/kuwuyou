...
import { FileText, AlertCircle, Loader2, X, Upload, ArrowLeft, Plus } from "lucide-react";
import { c as cn, u as useToast } from "./router-CXH_V1gJ.js";
...
import { f as formatNumber, K as KnowledgePagination } from "./KnowledgePagination-Kn0DwV5C.js";
import "clsx";
import { D as Dialog, c as DialogContent, d as DialogHeader, a as DialogTitle, b as DialogDescription } from "./dialog-DemXaHf5.js";
import { L as Label } from "./label-D-UJjBuw.js";
import { P as Progress } from "./progress-CmZS4Kld.js";
...
function KnowledgeDocumentsContent() {
  ...
  const fetchDocuments = async (page = 1, word = "") => {
    try {
      setLoading(true);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-screen bg-background", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto p-6", children: /* @__PURE__ */ jsx(DocumentList, { loading, documents, searchQuery, onDocumentClick: (doc) => console.log("点击文档:", doc) }) }),
      !loading && /* @__PURE__ */ jsx(KnowledgePagination, { currentPage, total, pageSize: 20, onPageChange: setCurrentPage })
    ] }),
    /* @__PURE__ */ jsx(UploadDocumentDialog, { open: uploadDialogOpen, onOpenChange: setUploadDialogOpen, knowledgeId, onUploadSuccess: () => fetchDocuments(currentPage, searchQuery) })
  ] });
}
export {
